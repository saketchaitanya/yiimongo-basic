...
if (!Yii::$app->session->get('session')=='active')
{
...
<head>
    ...
    <!-- Bootstrap core CSS (used bootstrap 3 in bootstrap folder for icon support missing in bootstrap 4) -->
  ...
  <!-- Material Design Bootstrap -->
    ...
    <link href="<?php echo  Yii::getAlias('@web').'/css/site.css'?>" rel="stylesheet">
    <style>
...
<?php $this->beginBody() ?>
                   ...
                   <!--  <div class="row">
                        <div class="col-md-12">
                            <div class="divider-new">
                                <h2 class="h2-responsive"><?php echo Html::encode($this->title); ?></h2>
                            </div>                            
                        </div>
                    </div> -->
                    <!--/.First row-->
    ...
    <script type="text/javascript" src="<?php echo $this->theme->baseUrl ?>/bootstrap/js/bootstrap.min.js"></script>
